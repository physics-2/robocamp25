...
public class CameraTest extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            telemetry.addData("Cube detected?", isCubeDetected ? "Yes" : "No");
            if (isCubeDetected) {
                telemetry.addData("Center", "(%d, %d)", (int) centerX, (int) centerY);
                telemetry.addData("Width (px)", (int) widthInPixels);
                telemetry.addData("Distance (in)", String.format("%.1f", calculateDistance(widthInPixels)));
            } else {
                telemetry.addData("Center", "N/A");
    ...
    public static class BlueCubePipeline extends OpenCvPipeline {
